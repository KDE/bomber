...
static const int SCORE_INCREMENT = 5;
...
int BomberGameWidget::level()
{
    return m_level;
}

int BomberGameWidget::score()
{
    return m_score;
}
...
void BomberGameWidget::mouseMoveEvent(QMouseEvent* event)
{
    Q_UNUSED(event);
}
...
void BomberGameWidget::generateOverlay()
{
    ...
    {
    case BeforeFirstGame:
        text = i18n("Welcome to Bomber.\n Click to start a game");
        break;
    case Paused:
        text = i18n("Paused");
        break;
    case BetweenLevels:
        text = i18n("You have successfully cleared level %1\n", m_level-1 )+i18n("On to level %1.", m_level );
        break;
    case GameOver:
        text = i18n("Game over.");
        break;
